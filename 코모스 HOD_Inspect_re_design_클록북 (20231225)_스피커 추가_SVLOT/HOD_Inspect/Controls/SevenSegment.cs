...
namespace DmitryBrant.CustomControls
{
    public class SevenSegment : UserControl
    {
        ...
        {
            base.OnPaddingChanged(e); this.Invalidate();
        }
        ...
        private void SevenSegment_Paint(object sender, PaintEventArgs e)
        {
            ...
            if (showDot)
                e.Graphics.FillRectangle(dotOn ? brushLight : brushDark, gridWidth - 1, gridHeight - elementWidth + 1, elementWidth, elementWidth);
